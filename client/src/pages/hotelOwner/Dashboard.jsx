        ...
        <table className='w-full'>
          <thead className='bg-gray-50'>
            <tr>
              ...
              <th className='py-3 px-4 text-gray-800 font-medium max-sm:hidden'>Room Image</th>
          ...
          <tbody className='text-sm'>
            {dashboardData.bookings.map((item,index)=>(
              <tr key={index}>
                ...
                <td className='py-3 px-4 text-gray-700 border-t border-gray-300 max-sm:hidden'>
                  <img
                    src={item.room?.images && item.room.images.length > 0 ? item.room.images[0] : assets.roomImg1}
                    alt="room-img"
                ...
                <td className='py-3 px-4 border-t border-gray-300 flex'>
                  <button className={`py-1 px-3 text-xs rounded-full mx-auto ${item.isPaid ? 'bg-green-200 txt-green-200' : 'bg-amber-200 text-yellow-600'}`}>
