...
const AddRoom = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler}>
      ...
      <p className='txt-gray-800 mt-10'>Images</p>
      ...
      <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
        ...
        <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm'>
          {Object.keys(inputs.amenities).map((amenity,index)=>(
            <div key={index}>
                <input type="checkbox" id={`amenities${index+1}`} checked={inputs.amenities[amenity]} onChange={()=> setInputs({...inputs,amenities: {...inputs.amenities,[amenity]: !inputs.amenities[amenity]}})} className='accent-blue-600'/>
