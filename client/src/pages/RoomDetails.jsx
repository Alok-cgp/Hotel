        ...
        <div className='flex flex-col lg:flex-row mt-6 gap-6'>
          ...
          <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
            {room?.images.length > 1 && room.images.map ((image,index)=>(
              ...
              src={image} key={index} alt="Room Imaage" className={`w-full rounded-xl shadow-md object-cover cursor-pointer ${mainImage === image && 'outline-3 outline-orange-500'}`}/>
            ))}
          </div>
        </div>
          ...
          <form onSubmit={onSubmitHandler} className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
            ...
            <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
              ...
              <div className='flex flex-col'>
                 ...
                 <div className='flex flex-col'>
                  ...
                  <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
               <div className='flex flex-col'>
                  <label htmlFor="checkOutguestsDate" className='font-medium'>Guests</label>
            ...
            <button
              ...
              className='bg-blue-600 hover:bg-blue-500 active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer'
            >
          ...
          <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            ...
            <div className='flex gap-4'>
              ...
              <button className='px-6 py-2.5 mt-4 rounded text-white bg-blue-600 hover:bg-blue-500 transition-all cursor-pointer'>
                Contact Now
              </button>
